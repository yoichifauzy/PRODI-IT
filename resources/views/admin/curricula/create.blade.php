...
@section('content')
    <div class="mb-4">
        <h1 class="text-2xl font-bold text-slate-900">Tambah Kurikulum</h1>
        <p class="text-sm text-slate-600">Buat data kurikulum baru.</p>
    </div>

    <form method="POST" action="{{ route('admin.curricula.store') }}" class="rounded-xl border border-slate-200 bg-white p-4">
        @csrf
